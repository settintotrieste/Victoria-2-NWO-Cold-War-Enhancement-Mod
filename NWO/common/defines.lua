...
country = {
	...
	GOLD_TO_WORKER_PAY_RATE = 2.4, -- Multiplier for how much money gold pays to pops
	...
	PROVINCE_OVERSEAS_PENALTY = 1.0, -- Each province req. this many goods flagged as overseas penalty 
...
economy = {
	...
	MAX_LOAN_CAP_FROM_BANKS = 2000, -- can loan max % of country tax base from single country
	...
	GOODS_FOCUS_SWAP_CHANCE = 6, -- Percebt increased chance that artisan wants to change goods independantly of how well he is doing presently
	...
	BANKRUPCY_DURATION = 100, -- Years til a bancrupcy clears all loans
...
diplomacy = {
	...
	AT_WAR_TENSION_DECAY = 0.5, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	...
	CRISIS_OFFER_RELATION_ON_ACCEPT = 100,
	CRISIS_OFFER_RELATION_ON_DECLINE = -100,
	...
	BACK_CRISIS_RELATION_ON_ACCEPT = 50,
	BACK_CRISIS_RELATION_ON_DECLINE = -10,
	CRISIS_TEMPERATURE_ON_OFFER_DECLINE = -10,
...
ai = {
	...
	SOLDIER_FRACTION = 0.01, -- max amount of population AI wants to be soldiers
